...
// app/api/submit-plan-request/route.ts
import { NextRequest, NextResponse } from 'next/server';

// Replace this with your deployed Apps Script web app URL
const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbxpMesbkVT6SxC0O7hHQNRfUTpN29OjjX3Ucn0aF7a9Kddb3hFbdQT2gIZRfcN9YGw/exec';
